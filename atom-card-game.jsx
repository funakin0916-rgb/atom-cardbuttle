...
const STAGES=[
  ...
  // ── EXステージ ──
  {id:11,bossId:11,name:"EX はじまりの試練",hl:7,deckSize:38,diff:"hard",bossName:"ネオバブリン",bossEmoji:"🫧",bossHp:50,bossColor:"#00BCD4",bossDesc:"進化したバブリン",ex:true,intro:"博士「バブリンが進化しておる！手札7枚じゃ！」",win:"博士「進化版も倒した！」",winStory:"博士「次は2体が合体したツインメタルじゃ！」",lose:"博士「手札が少ないと厳しいな…」"},
  {id:12,bossId:12,name:"EX 合体の遺跡",hl:7,deckSize:38,diff:"hard",bossName:"ツインメタル",bossEmoji:"⚔️",bossHp:60,bossColor:"#FF6E40",bossDesc:"銅と鉄の合体獣",ex:true,intro:"博士「銅と鉄が合体したツインメタルじゃ！」",win:"博士「合体モンスターも敵じゃないか！」",winStory:"博士「紫色の霧が…毒の女王じゃ！山札が少ない！」",lose:"博士「二重攻撃は強いな…」"},
  {id:13,bossId:13,name:"EX 毒の霧",hl:7,deckSize:35,diff:"hard",bossName:"ポイズンクイーン",bossEmoji:"☠️",bossHp:65,bossColor:"#AB47BC",bossDesc:"毒の女王",ex:true,intro:"博士「山札が少ないから短期決戦じゃ！」",win:"博士「毒の女王を浄化した！」",winStory:"博士「ワシの師匠・プロフェッサーXの力じゃ！」",lose:"博士「一手のミスが致命的じゃ…」"},
  {id:14,bossId:14,name:"EX 師匠の試練",hl:7,deckSize:35,diff:"hard",bossName:"プロフェッサーX",bossEmoji:"🧬",bossHp:75,bossColor:"#5C6BC0",bossDesc:"化学の神",ex:true,intro:"博士「ワシの師匠…化学の神と呼ばれた方じゃ」",win:"博士「師匠を超えた！！天才じゃ！」",winStory:"博士「赤い光が…正体不明の最後の敵じゃ！」",lose:"博士「さすが師匠…」"},
  {id:15,bossId:15,name:"EX 最終決戦",hl:7,deckSize:32,diff:"hard",bossName:"???",bossEmoji:"🌌",bossHp:85,bossColor:"#FF1744",bossDesc:"正体不明のモンスター",ex:true,intro:"博士「正体不明のモンスター！手札7枚＋山札最少の最凶ハンデ！」",win:"博士「あの姿は…若い頃のワシじゃったか！？完全なる化学マスターじゃ！！！」",winStory:"博士「すべてのモンスターが消えた…真の化学マスター！ありがとう！！」",lose:"博士「次元が違う…でもキミなら！」"}
];
...
window.__App=function App(){
  ...
  const startStage=st=>{setStage(st);setArmy([]);setCpuDiff(null);setVsState(null);setScr("card");if(BGM.on())BGM.start(st.diff==="hard"?"battle_hard":"battle");};
  const startCpu=(diff="normal")=>{
    ...
    setStage(cpuStage);setCpuDiff(diff);setVsState(null);setArmy([]);setScr("card");if(BGM.on())BGM.start("battle");
  };
  ...
  return <LangCtx.Provider value={lang}><style>{CSS}</style><BgmBtn/>
    ...
    {scr==="vsPass1"&&vsState&&<PassScreen nextName={vsState.p1} nextColor={vsState.p1Color} message="さいしょのひとに スマホを わたしてね" onReady={()=>{if(BGM.on())BGM.start("battle");setScr("vsCard");}}/>}
